...
while True:
    ...
    if ret:
        ...
        cv2.putText(undistorted_image, f"Pixel distance: {pixel_distance:.2f} px", (10, 30),
                    cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
        cv2.putText(undistorted_image, f"Real-world distance: {real_world_distance:.2f} mm", (10, 70),
                    cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
        cv2.putText(undistorted_image, f"Pixel-to-mm ratio: {pixel_to_mm_ratio:.4f} mm/px", (10, 110),
                    cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)

    else:
        # Display message when chessboard is not detected
        cv2.putText(undistorted_image, "Chessboard Not Detected", (10, 30), 
